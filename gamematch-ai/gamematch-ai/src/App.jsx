...
const Styles = () => (
  <style>{`
    ...
    * { cursor: none !important; }
    ...
    .store-steam { background:rgba(20,50,70,.5); border:1px solid rgba(30,90,130,.5); color:#c7d5e0; }
    .store-steam:hover { border-color:#2a9d8f; box-shadow:0 4px 14px rgba(42,157,143,.25); }
...
const GAMES = [
  ...
  "Resident Evil Village","Dead Space","Alien Isolation","Portal 2","Bioshock Infinite",
...
const getFallback = () => [
  {
    ...
    matchScore:97, matchColor:"#FF4655", setting:"Dark Fantasy",
    ...
    playtime:"60-150 hrs", label:"TOP PICK",
  },
  {
    title:"Baldur's Gate 3", developer:"Larian Studios", year:2023,
    genres:["RPG","Turn-Based","Co-op"], platforms:["PC","PS5"],
    matchScore:94, matchColor:"#FF4655", setting:"High Fantasy",
  ...
  {
    title:"Cyberpunk 2077", developer:"CD Projekt Red", year:2020,
    genres:["Action RPG","Open World"], platforms:["PC","PS5","Xbox"],
    matchScore:91, matchColor:"#FF4655", setting:"Cyberpunk",
    description:"Night City is one of gaming's greatest achievements. Post-Phantom Liberty, a near-perfect open-world narrative experience.",
    whyRecommended:"Ideal for players craving visual spectacle, layered storytelling, and an unforgettable city to get lost in.",
    highlights:["Stunning next-gen visuals","Deep narrative branches","Phantom Liberty DLC"],
    steamUrl:"https://store.steampowered.com/app/1091500/",
    epicUrl:"https://store.epicgames.com/en-US/p/cyberpunk-2077",
    playtime:"50-100 hrs", label:"VISUAL PICK",
  },
  {
    title:"Hollow Knight", developer:"Team Cherry", year:2017,
    genres:["Metroidvania","Platformer"], platforms:["PC","Switch","PS4"],
    matchScore:88, matchColor:"#FF4655", setting:"Underground Kingdom",
    description:"Hauntingly beautiful. Meticulously designed. Every secret tunnel earns its discovery tenfold.",
    whyRecommended:"Perfect for players who love tight, satisfying gameplay with surprising depth of world-building and atmosphere.",
    highlights:["Precise skill-based combat","Vast interconnected world","Iconic atmospheric soundtrack"],
    steamUrl:"https://store.steampowered.com/app/367520/",
    epicUrl:"https://store.epicgames.com/en-US/p/hollow-knight",
    playtime:"40-60 hrs", label:"INDIE PICK",
  },
  {
    title:"Hades", developer:"Supergiant Games", year:2020,
    genres:["Roguelike","Action"], platforms:["PC","Switch","PS5"],
    matchScore:86, matchColor:"#FF4655", setting:"Greek Mythology",
    description:"A roguelike where the story grows with every death. Narrative and gameplay loop are fused perfectly — one more run always beckons.",
    whyRecommended:"Exceptional replayability with fast, satisfying combat and a story that keeps revealing itself across many runs.",
    highlights:["Best-in-class story integration","Endless build variety","Incredibly tight combat"],
    steamUrl:"https://store.steampowered.com/app/1145360/",
    epicUrl:"https://store.epicgames.com/en-US/p/hades",
    playtime:"20-80 hrs", label:"REPLAYABILITY",
  },
  {
    title:"Red Dead Redemption 2", developer:"Rockstar Games", year:2018,
    genres:["Action Adventure","Open World"], platforms:["PC","PS4","Xbox One"],
    matchScore:84, matchColor:"#FF4655", setting:"Western Frontier",
    description:"Rockstar's magnum opus. A living, breathing world and a story about loyalty and loss that cuts genuinely deep.",
    whyRecommended:"Unmatched world immersion and character storytelling for players who prize narrative and atmosphere above all else.",
    highlights:["Best narrative in open-world gaming","Breathtaking world detail","Emotional character arcs"],
    steamUrl:"https://store.steampowered.com/app/1174180/",
    epicUrl:"https://store.epicgames.com/en-US/p/red-dead-redemption-2",
    playtime:"60-100 hrs", label:"NARRATIVE PICK",
  },
];
...
export default function App() {
  const [page, setPage]   = useState("landing"); // landing | quiz | loading | results
  ...
  const runAI = async () => {
    ...
    try {
      const prompt = `You are an elite video game recommendation AI. Based on this user profile, recommend exactly 6 games.
  ...
  if (page === "landing") return (
    <div style={{ minHeight:"100vh", background:"var(--darker)", position:"relative", overflow:"hidden" }}>
      ...
      <nav style={{
        ...
        <button className="btn-ghost" style={{ padding:"8px 22px" }}
      ...
      <div style={{
        ...
        <div style={{ maxWidth:780, animation:"fadeUp 0.7s cubic-bezier(.22,1,.36,1) both" }}>
          ...
          <p style={{
            ...
            profile against 50,000+ titles to find games you will actually love.
          </p>

          <div style={{ display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap" }}>
            <button className="btn-primary" style={{ padding:"17px 42px",display:"flex",alignItems:"center",gap:10 }}
              onClick={() => { setPage("quiz"); setStep(0); }}>
              INITIATE SCAN
              <ScopeArrow dir="right" size={18} color="#000"/>
            </button>
            <button className="btn-ghost" style={{ padding:"17px 30px" }}
                    ...
                    <div style={{ display:"flex",gap:10,flexWrap:"wrap" }}>
                      {game.steamUrl && (
                        <a href={game.steamUrl} target="_blank" rel="noopener noreferrer"
                          className="store-link store-steam">STEAM</a>
                      )}
                      {game.epicUrl && (
